        ...
        <div class="single-block-contant">
          ...
          <div class="breadcrumb-wrapper"> 
            <ul class="breadcrumb">
              ...
              <li><a href="./contractProduction.php">Контрактное производство</a></li>
              <li class="active">Автомобильная химия</li>
            </ul> 
            <img src="./img/him.png" alt="him" class="single-block-him"></div>           
        </div>
      </div>
    </div>
    </header>
