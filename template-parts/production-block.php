<section
  class="section production  <?= $production_contractProduction; ?>  <?= $production_contractProduction_main; ?> ">
  <div class="container">
    <?php
    if (!empty($block_title_production)) {
      echo ' <div class="seporator"></div>';
      echo '<h2 class= "section-title">' . $block_title_production . '</h2>';
    }
    ?>
    <div class="cards">
